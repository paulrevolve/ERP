  ...
  return (
    <div className="w-full flex items-center justify-center mt-1 ">
      <div className="flex items-center justify-end gap-1 px-2 py-1  border-gray-100 w-fit ml-auto text-sm text-gray-900">
        ...
        {/* Page Size Select */}
<div className="relative flex border border-gray-200 items-center rounded px-1 bg-white transition-colors !h-7">
          {/* bg-[#17414d] */}
 <select
  value={pageSize}
  onChange={(e) => {
  ...
  className="appearance-none bg-transparent !h-7 !min-h-0 !py-0 pr-3
             focus:outline-none cursor-pointer text-gray-700 !text-[9px]"
>
            <option value={15} className="text-black bg-white  text-[10px]">
              15 / page
            </option>
        ...
        <div className="flex items-center gap-1 text-[10px] ml-2">
          ...
          <input
            ...
            onKeyDown={handleGoTo}
            placeholder="#"
            className="!w-7 !h-7 !min-h-0 !p-0 border border-gray-200 outline-none bg-white rounded text-center !text-[9px] transition-all"
          />{" "}
        </div>
      </div>
    </div>
