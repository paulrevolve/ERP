    ...
    <div className="p-4 space-y-4 font-inter">
      <MainContainer icon={UserCheck} title="Manage Project Workforce">
        ...
        <div className="mt-4 space-y-6">
          ...
          {/* Employee Tables: ALWAYS visible in both views */}
          ...
          {/* PLC Mapping section: Appears BELOW the tab when active */}
          {showAssignPLC && (
...
export default ManageEmployeeWorkforce;
