...
const ConfigureEmailSettings = ({ onClose, loading }) => {
  const [isDirty, setIsDirty] = useState(false);
  ...
  const [apSettingInfo, setApSettingInfo] = useState(initialEmailState);
  const [originalData, setOriginalData] = useState(initialEmailState);
