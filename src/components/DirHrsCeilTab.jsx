...
const DirHrsCeilTab = ({ data, onChange, handleClose }) => {
  ...
  const handleFieldChange = (field, value, targetId = null) => {
    ...
    onChange(currentKey, "dirHrsCeils", updatedList);
  ...
  return (
    <SecondaryContainer title="Direct Hours Ceilings" handleClose={handleClose}>
      <Toolbar
        ...
        <div className="space-y-4 p-4 bg-gray-50 border border-gray-100 rounded mt-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormInput
              ...
              value={activeItem.laborCat || ""}
              onChange={(e) => handleFieldChange("laborCat", e.target.value)}
            />
            <FormInput
              label="Hours Ceiling"
