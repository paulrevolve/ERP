...
// const ManageVendorHoursCeilings = () => {
...
//       <MainContainer icon={null} title="Vendor Hours Ceilings">
//         <Toolbar 
...
//               <FormSection title="Vendor Hours Ceilings">
//                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
//                     <div className="space-y-2">
//                        <FormSearchSelect 
//                           label="Vendor *" 
//                           value={activeRecord.vendor} 
//                           options={[]} 
//                           displayKey="vendor" 
//                        />
//                        <FormInput label="Vendor Name" value={activeRecord.vendorName || ""} onChange={(e) => handleFieldChange(activeRecord.id, "vendorName", e.target.value)} />
//                     </div>
//                     <div className="space-y-2">
//                        <FormSearchSelect 
...
// export default ManageVendorHoursCeilings;
