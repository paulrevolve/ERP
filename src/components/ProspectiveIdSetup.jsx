...
const ProspectiveIDSetup = () => {
  ...
  return (
    <>
      <div className="min-h-screen text-gray-900 flex flex-col gap-y-2  p-2">
        ...
        <div className="w-full px-4 bg-white rounded-sm p-4 space-y-6 ">
          ...
          <div className=" p-4 rounded-sm ">
            ...
            {activeTab === "employee" && (
              <div className="space-y-2">
                <div className=" flex items-center justify-between">
                  <h3 className="input-label">Employee Data Entry</h3>
                  <div className="flex">
                    <button
                      onClick={handleAddEmployee}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 flex items-center">
                  <div className="flex gap-2 items-center">
                    <label htmlFor="hourlyRate" className="input-label">
                      Hourly Rate
                    </label>
                    <input
                      id="hourlyRate"
                  ...
                  <div className="flex gap-2 items-center">
                    <label htmlFor="plc" className="input-label">
                      PLC
                    </label>
                    <input
                      id="plc"
                  ...
                  <div className="flex gap-2 items-center">
                    <label htmlFor="homeOrg" className="input-label">
                      Home Org
                    </label>
                    <input
                      id="homeOrg"
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-300">
                  <table className="min-w-full divide-y divide-gray-300">
                    <thead className="bg-gray-200 thead">
                      <tr>
                        <th className="th-thead">Hourly Rate ($)</th>
                        <th className="th-thead">PLC</th>
                        <th className="th-thead">Salary ($)</th>
                        <th className="th-thead">Home Org</th>
                      ...
                      {employeeData.length === 0 ? (
                        ...
                        employeeData.map((row) =>
                          employeeEditingId === row.id ? (
                            ...
                            <tr key={row.id}>
                              <td className="tbody-td text-gray-900">
                                {row.hourlyRate}
                              </td>
                              <td className="tbody-td text-gray-800">
                                {row.plc}
                              </td>
                              <td className="tbody-td text-gray-800">
                                {row.salary}
            ...
            {activeTab === "vendor" && (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h3 className="input-label">Vendor Data Entry</h3>
                  <div>
                    <button onClick={handleAddVendor} className="btn1 btn-blue">
                      Add Vendor
                    </button>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                  <div className="flex items-center gap-4">
                    <label htmlFor="vendID" className="input-label">
                      Vend ID
                    </label>
                    <input
                      id="vendID"
                  ...
                  <div className="flex items-center gap-4">
                    <label htmlFor="vendName" className="input-label">
                      Vend Name
                    </label>
                    <input
                      id="vendName"
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-300">
                  <table className="min-w-full divide-y divide-gray-300">
                    <thead className="bg-gray-200 thead">
                      <tr>
                        <th className="th-thead">Vend ID</th>
                        <th className="th-thead">Vend Name</th>
                        <th className="th-thead">Actions</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {vendorData.length === 0 ? (
                        ...
                        vendorData.map((row) =>
                          vendorEditingId === row.id ? (
                            ...
                            <tr key={row.id}>
                              <td className="tbody-td">{row.vendID}</td>
                              <td className="tbody-td">{row.vendName}</td>
                              <td className="tbody-td">
                                <button
            ...
            {activeTab === "PLC" && (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h3 className="input-label">PLC Data Entry</h3>
                  <div className="flex justify-end">
                    <button onClick={handleAddPLC} className="btn1 btn-blue">
                      Add PLC
                    </button>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-4">
                    <label htmlFor="plcCategory" className="input-label">
                      Category
                    </label>
                    <input
                      id="plcCategory"
                  ...
                  <div className="flex items-center gap-4">
                    <label htmlFor="plcHrlyRate" className="input-label">
                      Hrly Rate
                    </label>
                    <input
                      id="plcHrlyRate"
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-300">
                  <table className="min-w-full divide-y divide-gray-300">
                    <thead className="bg-gray-200 thead">
                      <tr>
                        <th className="th-thead">Category</th>
                        <th className="th-thead">Hrly Rate</th>
                        <th className="th-thead">Actions</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {plcData.length === 0 ? (
                        ...
                        plcData.map((row) =>
                          plcEditingId === row.id ? (
                            ...
                            <tr key={row.id}>
                              <td className="tbody-td">{row.category}</td>
                              <td className="tbody-td">{row.hrlyRate}</td>
                              <td className="tbody-td">
                                <button
