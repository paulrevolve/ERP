...
const FinancialDashboard = () => {
  ...
  const getTabClasses = (tabName) =>
    `px-6 py-3 text-base font-semibold transition-all duration-300 focus:outline-none ${
      activeTab === tabName
        ...
        <div className="bg-white border-b sticky top-0 z-40">
          <div className="max-w-full mx-auto px-6 flex justify-between items-center">
            <div className="flex overflow-x-auto">
              ...
              <button
                className={getTabClasses("psrtrend")}
                onClick={() => setActiveTab("psrtrend")}
              >
                📈 PSR Trend
              </button>
              ...
              <button
                className={getTabClasses("is_report")}
                onClick={() => setActiveTab("is_report")}
              >
                📄 Income Statement
              </button>
            </div>
