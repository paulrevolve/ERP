...
const columns = [
  ...
  { id: "functionalCurrencyFeeOnHours", key: "functionalCurrencyFeeOnHours", label: "Functional Currency Fee on Hours" },
  { id: "applyToRBA", key: "applyToRBA", label: "Apply to R/B/A *" }
];

const ManageCostFeeOverrides = () => {
  ...
  return (
    <div className="p-4 space-y-4 font-inter">
      <MainContainer icon={DollarSign} title="Cost Fee Overrides">
        <Toolbar 
        ...
        <div className="mt-2">
          {isFormView ? (
            <div className="space-y-4">
              ...
              <FormSection title="Cost Fee Override Details">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                       ...
                       <FormInput label="Functional Currency Fee on Hours" value={activeRecord.functionalCurrencyFeeOnHours || ""} onChange={(e) => handleFieldChange(activeRecord.id, "functionalCurrencyFeeOnHours", e.target.value)} />
...
export default ManageCostFeeOverrides;
