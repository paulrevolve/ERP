...
const EmplHrsCeilTab = ({ data, onChange, handleClose }) => {
  ...
  const handleFieldChange = (field, value, targetId = null) => {
    ...
    onChange(currentKey, "emplHrsCeils", updatedList);
  ...
  return (
    <SecondaryContainer title="Employee Hours Ceilings" handleClose={handleClose}>
      <Toolbar
