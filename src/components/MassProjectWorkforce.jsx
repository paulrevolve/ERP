...
//               className={`text-[11px] font-bold underline transition-all ${
//                 showAssignPLC ? "text-[#17414d]" : "text-blue-600 hover:text-blue-800"
//               }`}
//             >
...
//                     <button className="px-3 py-1 text-[10px] font-bold bg-[#17414d] text-white rounded">Select</button>
//                 </div>
//                 <ReusableTable data={employees} columns={employeeColumns} onFieldChange={() => {}} />
//               </SecondaryContainer>
//               <SecondaryContainer title="Selected Employees">
//                 <div className="flex gap-2 justify-end mb-2">
//                     <button className="px-3 py-1 text-[10px] font-bold bg-[#17414d] text-white rounded">New</button>
//                     <button className="px-3 py-1 text-[10px] font-bold bg-[#17414d] text-white rounded">Copy</button>
//                     <button className="px-3 py-1 text-[10px] font-bold bg-[#17414d] text-white rounded">Delete</button>
//                 </div>
